...
void DrawTestCardWithFrame(CGContextRef context, NSRect frame)
{
    ...
    if (showText)
    {
        //// MirroredText
        {
            ...
            [@"Adept Virtual Cam " drawInRect: NSOffsetRect(labelRect, 0, 0) withAttributes: labelFontAttributes];
        ...
        //// RegularText
        {
            ...
            [@"Adept Virtual Cam " drawInRect: NSOffsetRect(label7Rect, 0, 0) withAttributes: label7FontAttributes];
